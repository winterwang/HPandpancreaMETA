...
tabletext<-cbind(
  c("Study: authors, year", "Raderer et al. 1998",
    ...
    "Risch et al. 2010", "Risch et al. 2014",
    "Shimoyama et al. 2010", "Schulte et al. 2015",
    "Gawin et al. 2012", "Hsu et al. 2014",
    "Qiao et al. 2012", "Dou et al. 2008",
    "Current study", NA, "Overall (Random Effects Model)"),
  c("Cases", "92", "121",
    "45", "87", "104", "373",
    "761",  "19", "580", "139",
    "11",  "63",  "85", "360",  NA, NA),
  c("Controls", "62", "226",  "45",
    "263", "262", "690", "794",  "34",
    "626", "177",  "11", "100", "136", "400",  NA, NA),
...
forestplot(tabletext, 
           ...
           lineheight = "auto", 
           is.summary=c(TRUE, rep(FALSE, 14), TRUE),
